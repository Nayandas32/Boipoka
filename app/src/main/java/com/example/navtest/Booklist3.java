...
public class Booklist3 extends Fragment {
    ImageView imageView1, imageView2, imageView3;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.booklist3, container, false);
        imageView1 = view.findViewById(R.id.btn31);
        imageView2 = view.findViewById(R.id.btn32);
        imageView3 = view.findViewById(R.id.btn33);
