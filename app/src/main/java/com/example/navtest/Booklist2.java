...
public class Booklist2 extends Fragment {
    ImageView imageView1, imageView2, imageView3;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.booklist2, container, false);
        imageView1 = view.findViewById(R.id.btn21);
        imageView2 = view.findViewById(R.id.btn22);
        imageView3 = view.findViewById(R.id.btn23);
